...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'ncarley';//this will be your WCC username
      $dbUsr = 'ncarley';//this will be your WCC username
      $dbPass = 'vWmjGzXLagJRV8X';//this will be the password found in the video.
